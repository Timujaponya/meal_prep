  ...
  return (
    <div className="group-block">
      <div className="group-header">
        ...
        <span className="group-count">{items.length} adet</span>
      </div>
  ...
  return (
    <section className="panel panel-glass">
      <div className="ingredient-toolbar">
        ...
        <p className="panel-meta">Toplam: {foods.length}</p>
      </div>

      <p className="panel-copy">Her kategoriden en az bir secim yapman gerekiyor. Satirdaki Sil ile listeden cikarabilirsin.</p>
      ...
      <form className="add-food-form" onSubmit={handleSubmit}>
        <h3 className="group-title">Yeni Malzeme Ekle</h3>
